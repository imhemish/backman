...
p. If you are using **Debian** and are familiar with **Makedeb Package Repository (MPR)**, there is a package there, called **"backman"**. You can install by cloning or using helper.
